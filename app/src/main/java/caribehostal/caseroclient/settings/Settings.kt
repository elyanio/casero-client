...
object Settings {
    ...
    @JvmStatic fun isPayAndVisionAcepted(): Boolean = prefs().getBoolean(PREFE_PAY_AND_VISION_ACEPTED,false)
    @JvmStatic fun setPayAndVisionAcepted(vari: Boolean) = prefs().edit().putBoolean(PREFE_PAY_AND_VISION_ACEPTED,vari).commit()
